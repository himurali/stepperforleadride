...
function App() {
  ...
  return (
    <div className="container">
      <Stepper>
        <Stepper.Steps>
          <Stepper.Step id="first" name="Inform">
            <StepBody>
              <p>Murlai ipsum dolor sit amet, consectetur adipisicing elit.</p>
              <div>
                <Button onClick={incrementCurrentStep}>Next step</Button>
              </div>
            </StepBody>
          </Stepper.Step>
          <Stepper.Step id="second" name="Inspire">
            <StepBody>
              <p>
          ...
          <Stepper.Step id="fifth" name="Step 5">
            <StepBody>
              <p>
                Accusamus alias asperiores beatae dolores et expedita molestias
                nihil tempora?
